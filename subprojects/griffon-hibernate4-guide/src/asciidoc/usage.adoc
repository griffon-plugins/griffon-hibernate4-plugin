...
| boolean
| false
| Establishes a connection to the datasource at the end of the `Bootstrap` phase.
...
The following is a trivial usage of the `{api_hibernate4_handler}` inside a service
