...
----
dependencies {
    griffon '{project-group}:griffon-hibernate4-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-hibernate4-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-hibernate4-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-hibernate4-plugin` BOM in your POM file, by placing the following
